(this["webpackJsonphellobuild-react"] = this["webpackJsonphellobuild-react"] || []).push([[47],{
...
var startKeyboardAssist = function (e) {
...
var startNativeListeners = function (e) {
...
var setKeyboardOpen = function (e, r) {
  fireKeyboardOpenEvent(e, r);
  keyboardOpen = true;
};

var setKeyboardClose = function (e) {
...
var keyboardDidResize = function (e) {
  return keyboardOpen && !keyboardDidClose(e);
};

var keyboardDidClose = function (e) {
  return keyboardOpen && currentVisualViewport.height === e.innerHeight;
};

var fireKeyboardOpenEvent = function (e, r) {
...
var fireKeyboardCloseEvent = function (e) {
  var r = new CustomEvent(KEYBOARD_DID_CLOSE);
  e.dispatchEvent(r);
};

var trackViewportChanges = function (e) {
  previousVisualViewport = Object.assign({}, currentVisualViewport);
  currentVisualViewport = copyVisualViewport(e.visualViewport);
};

var copyVisualViewport = function (e) {
  return {
